% Plots in the Fig. 8 in the submitted Manuscript are generated 
%==========================================================================
% We compute the actual Outage Probability (P_out) and compare with the
% corrected Upper bounds (Eq. (64) in [1])
% 
...
Outage_prob_bound = zeros(len,1);  %  Eq. (64) in [1]
...
for i = 1:1:len
                ...
                Outage_prob_bound(i) = p1; % Eq. (64) 
                
                                
                Outage_prob_actual(i) = CDF_max(lamda0);  % actual outage probability
                               
                
end

% RED curves for bound
plot(SNR_dB,Outage_prob_bound,'r');

hold on;


% BLUE curves for actual
